...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<h1 data-id=\"\" class=\"create-file\">Add File</h1>\n\n  <form class=\"create-file\">\n    <fieldset>\n      <input type=\"file\" name=\"fileupload[file]\">\n      <input type=\"text\" name=\"fileupload[title]\" autocomplete=\"title\" placeholder=\"File name\" required>\n      <input type=\"text\" name=\"fileupload[tags]\" autocomplete=\"tags\" placeholder=\"Tags (ex. cat, dog)\">\n\n      <input type=\"radio\" name=\"fileupload[publicFile]\" value=\"true\" checked=\"checked\"><label >Public</label>\n\n      <input type=\"radio\" name=\"fileupload[publicFile]\" value=\"false\"><label>Private</label>\n\n      <input class=\"button\" type=\"submit\" value=\"Upload File\">\n    </fieldset>\n  </form>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<nav class=\"navbar navbar-default\">\n  <div class=\"container-fluid\">\n    <div class=\"navbar-header\">\n      <a class=\"navbar-brand\" href=\"#\">\n        <!-- Brand Logo -->\n        <i class=\"far fa-folder-open fa-spin\"></i>\n        <i class=\"fab fa-firefox fa-spin\"></i>\n      </a>\n    </div>\n    <!-- sign out button -->\n\n    <button type=\"button\" class=\"sign-out btn btn-default navbar-btn navbar-right\">Sign Out</button>\n\n    <!-- change password dropdown -->\n    <div class=\"account-info\">\n      <p>Signed in as: "
    ...
    + ((stack1 = container.invokePartial(__webpack_require__(34),depth0,{"name":"change-password","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "</a></li>\n    </ul>\n  </div>\n  </div>\n</nav>\n";
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "\n<div class=\"jumbotron\">\n  <div class=\"jumbotron-content\">\n    <h1>Welcome to Foxy File!</h1>\n    <p>Sign up or sign in to get started!</p>\n  <div class=\"jumbotron-button\">\n    <!-- Large modal -->\n<button type=\"button\" class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#sign-in-modal\">Sign Up or Sign In</button>\n\n</div>\n    <p>File the Foxy Way!</p>\n</div>\n</div>\n<div class=\"modal fade bs-example-modal-lg\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myLargeModalLabel\" id=\"sign-in-modal\">\n  <div class=\"modal-dialog modal-lg\" role=\"document\">\n    <div class=\"modal-content\">\n      <ul class=\"nav nav-tabs\">\n        <li role=\"presentation\" class=\"active\"><a href=\"#signin\">Sign In</a></li>\n        <li role=\"presentation\"><a href=\"#signup\">Sign Up</a></li>\n      </ul>\n      <div class=\"tab-content\">\n      <div role=\"tabpanel\" class=\"tab-pane active\" id=\"signin\">"
    + ((stack1 = container.invokePartial(__webpack_require__(38),depth0,{"name":"sign-in","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "</div>\n  <div role=\"tabpanel\" class=\"tab-pane\" id=\"signup\">"
    + ((stack1 = container.invokePartial(__webpack_require__(39),depth0,{"name":"sign-up","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "</div>\n</div>\n\n      </ul>\n    </div>\n  </div>\n</div>\n";
},"usePartial":true,"useData":true});
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://warm-tor-57872.herokuapp.com',
...
var onCreateFileUpload = function onCreateFileUpload(event) {
  event.preventDefault();
  var formData = new FormData(event.target);
  $('.create-file input[type="submit"]').attr('disabled', 'true');
  // console.log('form data in submit is: ', formData)
  api.createFileUpload(formData).then(ui.createFileUploadSuccess).catch(ui.createFileUploadFailure);
};

var onUpdateFileUpload = function onUpdateFileUpload(event) {
  event.preventDefault();
  ...
  .then(onGetFileUploadNoEvent).catch(ui.getFileUploadFailure);
};

var onDeleteFileUpload = function onDeleteFileUpload(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  // console.log(data)
...
var onGetFileUpload = function onGetFileUpload(event) {
  event.preventDefault();
  // const data = getFormFields(event.target)
  api.getFileUpload().then(ui.getFileUploadSuccess);
  // .catch(ui.)
};

var deleter = function deleter(e) {
  e.preventDefault();
  // console.log('delete ')
  var id = $(e.target).children().attr('data-id');
  var data = { fileupload: { id: $(e.target).children().attr('data-id') }
    // console.log('item to delete has id of', data)
  };api.deleteFileUpload(data).then(ui.deleteFileUploadSuccess).then(function () {
    $('#' + id).fadeOut();
    $('#' + id + '-all').fadeOut();
  }).then(function () {
    $('#' + id).remove();
...
var onGetFileUploadNoEvent = function onGetFileUploadNoEvent() {
  // const data = getFormFields(event.target)
  api.getFileUpload().then(ui.getFileUploadSuccess);
...
var onShowUpdate = function onShowUpdate(e) {
  // console.log($(e.target).attr('data-id'))

  var updateFileUploadHandlebars = __webpack_require__(45);
  var updateFileUploadHTML = updateFileUploadHandlebars({ fileId: $(e.target).attr('data-id') });
...
module.exports = {
  ...
  onGetFileUploadNoEvent: onGetFileUploadNoEvent
};
...
var navHandlebars = __webpack_require__(8);
var navHTML = navHandlebars();

var homePageHandlebars = __webpack_require__(9);
var homePageHTML = homePageHandlebars();

var footerHandlebars = __webpack_require__(46);
var footerHTML = footerHandlebars();
...
var fileEvents = __webpack_require__(11);
...
var onSignIn = function onSignIn(event) {
  ...
  api.signIn(data).then(ui.signInSuccess).then(function () {
    fileEvents.onGetFileUploadNoEvent();
...
var signInSuccess = function signInSuccess(data) {
  ...
  var createFileUploadHandlebars = __webpack_require__(6);
  var createFileUploadHTML = createFileUploadHandlebars();
  //
  ...
  var navHandlebars = __webpack_require__(8);
  var navHTML = navHandlebars({ username: store.user.username });

  // const scrollFileHandlebars = require('../templates/scrollfile.handlebars')
  // const scrollFileHTML = scrollFileHandlebars()

  var containerHandlebars = __webpack_require__(35);
  var containerHTML = containerHandlebars();
  ...
  var signOutUserHandlebars = __webpack_require__(37);
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"container\">\n  <div class=\"row\">\n    <div class=\"col-sm-12 add-file-box\">\n"
    + ((stack1 = container.invokePartial(__webpack_require__(6),depth0,{"name":"file-upload/create-file","data":data,"indent":"      ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "    </div>\n  </div>\n  <div class=\"row\">\n"
    + ((stack1 = container.invokePartial(__webpack_require__(36),depth0,{"name":"scrollfile","data":data,"indent":"    ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "  </div>\n</div>\n";
},"usePartial":true,"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"scrollable\">\n\n  <!-- Nav tabs -->\n  <ul class=\"file-tabs nav nav-tabs\" role=\"tablist\">\n    <li role=\"presentation\" class=\"active\"><a href=\"#myfiles\" aria-controls=\"home\" role=\"tab\" data-toggle=\"tab\">My Files</a></li>\n    <li role=\"presentation\"><a href=\"#allfiles\" aria-controls=\"profile\" role=\"tab\" data-toggle=\"tab\">All Files</a></li>\n  </ul>\n\n  <!-- Tab panes -->\n  <div class=\"scrollable-tab-content tab-content\">\n    <div role=\"tabpanel\" class=\"tab-pane active\" id=\"myfiles\">\n      <div class=\"myfiles-content\">\n\n        </div>\n    </div>\n    <div role=\"tabpanel\" class=\"tab-pane\" id=\"allfiles\">\n      <div class=\"all-files-content\">\n\n      </div>\n\n    </div>\n  </div>\n\n</div>\n";
},"useData":true});
...
var viewMyFileUploadHandlebars = __webpack_require__(42);
var viewAllFileUploadHandlebars = __webpack_require__(43);

var createFileUploadSuccess = function createFileUploadSuccess(data) {
  // console.log(data)``
...
var createFileUploadFailure = function createFileUploadFailure() {
...
var updateFileUploadSuccess = function updateFileUploadSuccess(data) {
...
var updateFileUploadFailure = function updateFileUploadFailure() {
...
var deleteFileUploadSuccess = function deleteFileUploadSuccess(data) {
  // console.log(data)
...
var deleteFileUploadFailure = function deleteFileUploadFailure() {
...
var getFileUploadSuccess = function getFileUploadSuccess(data) {
  // console.log(data)
  $('.tab-title').remove();
  $('.my-files').remove();
  $('.all-files').remove();
  ...
  // console.log(myFiles)
  var myResultsHtml = '<h3 class="tab-title">My Files</h3><div class="my-files">';
  myFiles.forEach(function (result) {
    var myFileUploadHTML = viewMyFileUploadHandlebars({ result: result });
    myResultsHtml = myResultsHtml + myFileUploadHTML;
  });
  var resultsHtml = '<h3 class="tab-title">All Files</h3><div class="all-files">';
  publicFiles.forEach(function (result) {
    var allFileUploadHTML = viewAllFileUploadHandlebars({ result: result });
...
var getFileUploadFailure = function getFileUploadFailure() {
...
module.exports = {
  createFileUploadSuccess: createFileUploadSuccess,
  createFileUploadFailure: createFileUploadFailure,
  updateFileUploadSuccess: updateFileUploadSuccess,
  updateFileUploadFailure: updateFileUploadFailure,
  deleteFileUploadSuccess: deleteFileUploadSuccess,
  deleteFileUploadFailure: deleteFileUploadFailure,
  getFileUploadSuccess: getFileUploadSuccess,
  getFileUploadFailure: getFileUploadFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <p>Tags: "
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.result : depth0)) != null ? stack1.tag : stack1), depth0))
    + "</p>\n";
},"3":function(container,depth0,helpers,partials,data) {
    return "   <p>This file is public and can be seen by all Foxy File users.</p>\n";
},"5":function(container,depth0,helpers,partials,data) {
    return "   <p>This file is private, for your eyes only!</p>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression, alias3=depth0 != null ? depth0 : (container.nullContext || {});

  return "<div id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.result : depth0)) != null ? stack1._id : stack1), depth0))
    + "\"  class=\"display-file\">\n   <p><a href=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.result : depth0)) != null ? stack1.url : stack1), depth0))
    + "\" download=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.result : depth0)) != null ? stack1.title : stack1), depth0))
    + "\" target=\"_blank\">"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.result : depth0)) != null ? stack1.title : stack1), depth0))
    + "</a></p>\n   <p>Owner: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.result : depth0)) != null ? stack1.owner : stack1), depth0))
    + "</p>\n   <p>Created: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.result : depth0)) != null ? stack1.createdAt : stack1), depth0))
    + "</p>\n   <p>Updated: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.result : depth0)) != null ? stack1.updatedAt : stack1), depth0))
    + "</p>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = (depth0 != null ? depth0.result : depth0)) != null ? stack1.tag : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = (depth0 != null ? depth0.result : depth0)) != null ? stack1.publicFile : stack1),{"name":"if","hash":{},"fn":container.program(3, data, 0),"inverse":container.program(5, data, 0),"data":data})) != null ? stack1 : "")
    + "\n  <form class=\"delete-single-file\"><input  data-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.result : depth0)) != null ? stack1._id : stack1), depth0))
    + "\" type=\"submit\" value=\"Delete\"></form>\n  <button class=\"show-update\" data-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.result : depth0)) != null ? stack1._id : stack1), depth0))
    + "\">Update</button>\n</div>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div id=\""
    ...
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.result : depth0)) != null ? stack1.updatedAt : stack1), depth0))
    + "</p>\n"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = (depth0 != null ? depth0.result : depth0)) != null ? stack1.tag : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "</div>\n";
},"useData":true});
...
var createFileUpload = function createFileUpload(formData) {
...
var updateFileUpload = function updateFileUpload(data) {
  return $.ajax({
...
var deleteFileUpload = function deleteFileUpload(data) {
  return $.ajax({
    url: config.apiUrl + '/fileuploads/' + data.fileupload.id,
    method: 'DELETE',
    headers: {
...
var getFileUpload = function getFileUpload(data) {
  return $.ajax({
    method: 'GET',
    url: config.apiUrl + '/fileuploads',
    headers: {
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<h4 data-id=\"\" class=\"update-file\">Update File</h4>\n\n  <form class=\"update-file\">\n    <fieldset>\n      <input type=\"text\" name=\"fileupload[id]\" autocomplete=\"id\" placeholder=\"file ID\" required value=\""
    + container.escapeExpression(((helper = (helper = helpers.fileId || (depth0 != null ? depth0.fileId : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"fileId","hash":{},"data":data}) : helper)))
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "\n<footer class=\"footer\">\nFile Foxy	&trade;  2018.  Made with &hearts; by team Jorgie\n</footer class=\"footer\">\n";
},"useData":true});
